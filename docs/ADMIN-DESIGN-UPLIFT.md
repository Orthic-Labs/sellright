...
4. **Real logo** — replace the green-square placeholder in the sidebar + login with the wordmark. (Right Suite identity is for the *RightSites* fork, not SellRight-the-product — keep SellRight brand-neutral.)
