...
export default component$(() => {
 ...
 <div class="bg-white min-h-screen">
  ...
  <p>
   Given the nature of some of our products, age verification is required for purchases, and we strongly recommend parental supervision for any interaction with our website by minors.
  </p>
