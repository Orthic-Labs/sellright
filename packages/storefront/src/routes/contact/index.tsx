...
export default component$(() => {
	...
	return (
		<div class="bg-[var(--color-parchment)] min-h-screen py-6 sm:py-8 lg:py-10">
			<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
				<div class="max-w-4xl mx-auto">
					<div class="grid lg:grid-cols-2 gap-12 lg:gap-16">
						{/* Contact Form */}
						<div>
							<h1 class="font-['Cormorant_Garamond'] text-3xl font-bold text-[var(--color-ink)] mb-6">Get In Touch</h1>

							{formState.value === 'success' ? (
								<div class="bg-white rounded-lg p-8 text-center shadow-sm">
									<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="w-16 h-16 text-[var(--color-accent)] mx-auto mb-4"><circle cx="12" cy="12" r="10"/><path d="m9 12 2 2 4-4"/></svg>
									<h2 class="font-['Cormorant_Garamond'] text-2xl font-bold text-[var(--color-ink)] mb-2">Check Your Email</h2>
									...
									<div class="space-y-5">
										<div>
											...
											<input
												...
												class="w-full px-4 py-2.5 border border-[#e0d8ce] rounded bg-[#FDFAF6] text-[var(--color-ink)] text-sm font-['IBM_Plex_Sans'] focus:outline-none focus:border-[var(--color-accent)] transition-colors"
										...
										<div>
											...
											<textarea
												...
												rows={5}
												class="w-full px-4 py-2.5 border border-[#e0d8ce] rounded bg-[#FDFAF6] text-[var(--color-ink)] text-sm font-['IBM_Plex_Sans'] focus:outline-none focus:border-[var(--color-accent)] transition-colors resize-vertical"
						...
						<div>
							<h2 class="font-['Cormorant_Garamond'] text-3xl font-bold text-[var(--color-ink)] mb-6">Contact Info</h2>
							...
							<div class="space-y-4">
								<div class="bg-white rounded-lg p-5 shadow-sm">
									<h3 class="text-sm font-medium text-[var(--color-ink)] mb-2 font-['IBM_Plex_Sans'] uppercase tracking-wider">Shipping Policy</h3>
									<p class="text-[#555] text-sm font-['IBM_Plex_Sans']">In stock products ship within 2 working days via standard shipping.</p>
								</div>
								<div class="bg-white rounded-lg p-5 shadow-sm">
									<h3 class="text-sm font-medium text-[var(--color-ink)] mb-2 font-['IBM_Plex_Sans'] uppercase tracking-wider">Warranty Policy</h3>
								...
								<div class="bg-white rounded-lg p-5 shadow-sm">
									<h3 class="text-sm font-medium text-[var(--color-ink)] mb-2 font-['IBM_Plex_Sans'] uppercase tracking-wider">Spare Parts</h3>
