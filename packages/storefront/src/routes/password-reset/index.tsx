...
export const head = () => {
	return createSEOHead({
		...
		description: `Set a new password for your ${theme.storeName} account.`,
		noindex: true,
	});
};
			...
			<div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
				<div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
					...
					<p class="mt-2 text-center text-sm text-gray-600">Choose a new password</p>
							...
							<div>
								<button
									class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[var(--color-accent)] hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 disabled:opacity-50 disabled:cursor-not-allowed"
									onClick$={reset}
