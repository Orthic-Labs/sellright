  ...
  <div class="sr-trust">
    <div class="sr-trust-item">
      ...
      <div class="sr-trust-text">
        <span class="sr-trust-val">Free</span>
        <span class="sr-trust-lbl">Ship over $100</span>
      </div>
    </div>
    <div class="sr-trust-item">
      ...
      <div class="sr-trust-text">
        <span class="sr-trust-val">1 week</span>
        <span class="sr-trust-lbl">Defect returns</span>
      </div>
    </div>
    <div class="sr-trust-item">
      ...
      <div class="sr-trust-text">
        <span class="sr-trust-val">Secure</span>
        <span class="sr-trust-lbl">Checkout</span>
      </div>
    </div>
  </div>
));
