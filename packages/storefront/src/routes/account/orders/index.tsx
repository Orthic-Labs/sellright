...
import { getActiveCustomerOrdersQuery } from '~/services/customer';
									...
									>
										...
										{isExpanded && (
											<div class="p-4 bg-white">
												...
												<div class="mb-4">
													<div class="bg-[var(--color-parchment)] rounded-[3px] p-4 border border-[#E5E0D8]">
												...
												<div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
													{order.shippingAddress && (
														<div class="bg-[var(--color-parchment)] border border-[#E5E0D8] rounded-[3px] p-3 h-full">
