...
export default component$(() => {
 ...
 <div class="bg-white min-h-screen">
  ...
  <p>
   <strong>IMPORTANT:</strong> Some of our products are intended for adult use only and may be unsuitable or unsafe for minors. Parents and guardians are responsible for ensuring that minors do not access or use these products.
  </p>

  <h2 class="text-2xl font-bold text-black mt-8 mb-4">Product Categories and Warnings</h2>
  <h3 class="text-xl font-bold mt-6 mb-3">Product Safety</h3>
  <p>
   Some products in our catalog may carry inherent risks depending on their nature and intended use. By purchasing these items, you acknowledge that:
  </p>
  <ul class="list-disc pl-5 space-y-2">
   ...
   <li>You will store these products safely and away from unauthorized users</li>
  ...
  <p>
   Some of our products, including small components or accessories, may present choking hazards, particularly to children under 3 years of age. By purchasing these items, you acknowledge that:
  </p>
  <ul class="list-disc pl-5 space-y-2">
  ...
  <ul class="list-disc pl-5 space-y-2">
   <li><strong>Inherent Risks:</strong> Certain products in our catalog may carry inherent risks and can cause injury if misused, handled improperly, or used by untrained individuals.</li>
