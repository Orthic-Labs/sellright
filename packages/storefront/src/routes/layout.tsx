	...
	return (
		...
		<LoginModalProvider>
			<div>
				...
				<div style={{ position: 'relative', minHeight: '100vh', backgroundColor: 'var(--color-parchment)' }}>
					<main id="main-content" class={`flex-1 bg-[var(--color-parchment)] ${isHomePage || isAffiliateSurface ? '' : 'pt-16'}`}>
						<Slot />
					</main>
