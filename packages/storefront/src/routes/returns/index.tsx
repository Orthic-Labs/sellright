...
export default component$(() => {
 ...
 <div class="bg-white min-h-screen">
  ...
  <p>
   Due to the nature of some of our products, we maintain a strict returns policy to ensure safety and legal compliance. All sales are final unless the product arrives damaged, defective, or significantly different from what was ordered.
  </p>
