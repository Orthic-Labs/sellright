...
import SrGatewayPayment from '~/components/payment/SrGatewayPayment';
...
import type { SrShopConfig } from '~/utils/sellright';
...
interface CheckoutPaymentPanelProps {
  ...
  shopConfig: Signal<SrShopConfig | null>;
  srState: any;
          ...
          <div class="overflow-hidden">
            {SR_CHECKOUT_ENABLED ? (
              <div id="stripe-payment-element-section" style="scroll-margin-top:16px;">
                {props.srState.phase === 'paying' && props.shopConfig.value && !props.shopConfig.value.stripeConfigured && (props.shopConfig.value.gateways.nmi || props.shopConfig.value.gateways.sezzle) ? (
                  <SrGatewayPayment
                    orderCode={props.srState.code}
                    receiptToken={props.srState.receiptToken}
                    nmi={props.shopConfig.value.gateways.nmi}
                    sezzle={props.shopConfig.value.gateways.sezzle}
                    formattedTotal={props.formattedTotal.value}
