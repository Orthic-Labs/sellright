...
export default component$<OrderProcessingModalProps>(({ isVisible, currentStage }) => {
  ...
  return (
    <div class="fixed inset-0 bg-black/75 flex items-center justify-center z-50 backdrop-blur-xs">
      <div class="bg-[var(--color-parchment)] rounded-2xl shadow-2xl p-8 max-w-md w-full mx-4 text-center relative overflow-hidden">
        {/* Animated background */}
        <div class="absolute inset-0 bg-linear-to-br from-[var(--color-parchment-hover)] to-[var(--color-parchment)] opacity-50"></div>
