...
export default component$(() => {
	...
	useTask$(async ({ track, cleanup }) => {
		...
		const selectedShippingMethod = await fetchCartShippingMethod(countryCode, orderTotalAfterDiscount);
		if (cancelled) return;
			...
			{appState.showCart && (
				<div class="fixed inset-0 z-[9999] flex">
					...
					<div
						...
						class="relative ml-auto h-full w-[85vw] sm:w-[35vw] sm:max-w-[620px] flex flex-col bg-[var(--color-parchment)] shadow-[-6px_0_32px_rgba(0,0,0,0.14)]"
						tabIndex={-1}
