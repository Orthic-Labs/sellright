export const STYLES = `
  /* ── Color palette ── */
  .hp { --accent: var(--color-accent); --accent-light: var(--color-accent-hover); --accent-glow: rgba(var(--color-accent-rgb),0.35); --accent-dim: rgba(var(--color-accent-rgb),0.12); --dark: #0A0A0A; --dark-elevated: var(--color-ink); --dark-surface: #1A1A1A; --dark-border: #2A2A28; --parchment: var(--color-parchment); --parchment-deep: #EDE7DC; --warm-grey: #706860; --off-white: #F5F0E8; --text-on-dark: #E8E2D8; --text-on-dark-secondary: #9A9488; --text-on-light: #1A1A1A; --text-on-light-secondary: #5A5650; }
