...
export default component$<Props>(({ countryCode, orderTotalAfterDiscount, currencyCode }) => {
	...
	return (
		<div class="bg-[var(--color-parchment)] border border-[#E5E0D8] rounded-md p-3 mb-4">
			...
			<div class="w-full bg-[#E5E0D8] rounded-full h-1.5">
				<div
					class="bg-[var(--color-accent)] h-1.5 rounded-full transition-all duration-300 ease-out"
