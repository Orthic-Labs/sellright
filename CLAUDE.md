# SellRight Claude Instructions

## Workspace Rules

This repo lives inside Adrian's `D:\Claude` workspace. For Claude Code, read
and apply `D:\Claude\CLAUDE.md` before substantial work; this file adds
SellRight-specific rules and does not replace the studio rules.

Codex should use the sibling `AGENTS.md`, which points at
`D:\Claude\AGENTS.md` and mirrors these local rules.
